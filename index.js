...
Object.defineProperty(ScienceBook,'info', {
    ...
    get(){
        return `Про книгу ${this.title}: ${this._info || 0}`
         },
       });
...
const textbook = Object.create(Textbook,{ title: {value:"Фізика у Вищій Школі"}, author:{value:"Дж. Д. Джонс"},});
